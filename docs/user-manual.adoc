  ...
  jdbc:
    dataSource:
      ...
      ds_master_0:
        ...
        url: jdbc:mysql://mysql.fengdai.org:3306/demo_ds_master_0
        username: root
        password: tairan2017!
      ds_master_0_slave_0:
        type: org.apache.commons.dbcp.BasicDataSource
        driverClassName: com.mysql.jdbc.Driver
        url: jdbc:mysql://mysql.fengdai.org:3306/demo_ds_master_0_slave_0
        username: root
        password: tairan2017!
      ds_master_0_slave_1:
        type: org.apache.commons.dbcp.BasicDataSource
        driverClassName: com.mysql.jdbc.Driver
        url: jdbc:mysql://mysql.fengdai.org:3306/demo_ds_master_0_slave_1
        username: root
        password: tairan2017!
      ds_master_1:
        type: org.apache.commons.dbcp.BasicDataSource
        driverClassName: com.mysql.jdbc.Driver
        url: jdbc:mysql://mysql.fengdai.org:3306/demo_ds_master_1
        username: root
        password: tairan2017!
      ds_master_1_slave_0:
        type: org.apache.commons.dbcp.BasicDataSource
        driverClassName: com.mysql.jdbc.Driver
        url: jdbc:mysql://mysql.fengdai.org:3306/demo_ds_master_1_slave_0
        username: root
        password: tairan2017!
      ds_master_1_slave_1:
        type: org.apache.commons.dbcp.BasicDataSource
        driverClassName: com.mysql.jdbc.Driver
        url: jdbc:mysql://mysql.fengdai.org:3306/demo_ds_master_1_slave_1
        username: root
        password: tairan2017!
...
NOTE: 为能更及时的对服务异常做出处理，dew增加邮件通知功能。
...
dew:
  cloud:
    error:
      notify-interval-mill-sec: 10000
      notify-emails: 71964899@qq.com
      notify-event-types: FAILURE,SHORT_CIRCUITED,TIMEOUT,EMIT,THREAD_POOL_REJECTED,SEMAPHORE_REJECTED
      judge-type: include
      notify-include-keys: ["ExampleClient#deleteExe(int,String)","ExampleClient#postExe(int,String)"]
----

TIP: password为smtp授权码，非邮箱密码
