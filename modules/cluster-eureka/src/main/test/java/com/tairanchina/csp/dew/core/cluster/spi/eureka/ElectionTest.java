...
@SpringBootTest(classes = DewCloudApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
...
public class ElectionTest {
    ...
    public void testAll() throws Exception {
        while (true) {
            System.out.println("Is Leader: " + Dew.cluster.election.isLeader());
